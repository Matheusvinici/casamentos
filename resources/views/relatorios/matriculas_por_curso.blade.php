...
<div class="container py-5">
    <h1 class="mb-5 text-center fw-bold text-primary">Matrículas por Curso</h1>
    
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('Relatorios-Matriculas-Por-Curso') }}" class="row g-3 align-items-end">
                <div class="col-md-5">
    ...
    <div class="mb-4">
        <a href="{{ route('Relatorios-Matriculas-Por-Curso', array_merge(request()->all(), ['download' => true])) }}" 
