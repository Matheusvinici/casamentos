{{-- resources/views/livewire/letivos/letivos-create.blade.php --}}
<div>
    {{-- Erros de validação: Mostra lista se houver --}}
    @if ($errors->any())
    ...
    {{-- Alerta se sem turmas: Impede create sem dados --}}
    @if($turmas->isEmpty())
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    @if(isset($calendarioVisualizacao))
                        <div class="small mt-1">Calendário: <strong>{{ $calendarioVisualizacao->nomeCompleto }}</strong></div>
                    @endif
                </div>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    {{-- Form: Submit chama save() no Livewire --}}
    <form wire:submit.prevent="save">
        {{-- Seção 1: Turma (compartilhada) + Semestre --}}
        <div class="row mb-4">
            <div class="col-md-12 mb-3">
                ...
                <select wire:model.live="turma_id" 
                    ...
                    {{-- Loop: Mostra turmas com detalhes, incluindo semestre (unidade->nome) --}}
                ...
                @if($turmas->isNotEmpty())
                    <small class="text-muted mt-1 d-block">
                        ...
                        Selecione a turma para definir os horários das aulas
                    </small>
                @endif
            </div>
            
            @if($turma_selecionada_info)
                <div class="col-md-12 mt-2">
                    <div class="alert alert-light border">
                        <div class="d-flex align-items-start">
                            <i class="fas fa-chalkboard-teacher text-info me-2 mt-1"></i>
                            <div>
                                <small class="text-muted d-block">Turma Selecionada:</small>
                                <span class="fw-medium">{{ $turma_selecionada_info }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{-- Seções de Aulas: Loop para cada seção --}}
        <div class="mb-4">
            ...
            @foreach($sections as $index => $section)
                <div class="card border-light mb-3 shadow-sm">
                    ...
                    <div class="card-body p-3">
                        {{-- Row: Dia, Horário Início, Saída e Duração --}}
                        <div class="row g-2">
                            <div class="col-md-3">
